...
from .static_text import (BACK_RU, MENU_RU, BACK_UZ, MENU_UZ,
                          CATEGORY_TEXT_RU, CATEGORY_TEXT_UZ, CONDITION_TEXT_RU, CONDITION_TEXT_UZ, MESSAGE_TEXT_UZ, MESSAGE_TEXT_RU)
...
def message_keyboard_uz():
    ...
    return ReplyKeyboardMarkup(
        keyboard=keyboard,
        resize_keyboard=True,
        input_field_placeholder=MESSAGE_TEXT_UZ
    )
...
def message_keyboard_ru():
    keyboard = []

    keyboard.append([KeyboardButton(button) for button in CONTROL_BUTTONS_RU])

    return ReplyKeyboardMarkup(
        keyboard=keyboard,
        resize_keyboard=True,
        input_field_placeholder=MESSAGE_TEXT_RU
    )
